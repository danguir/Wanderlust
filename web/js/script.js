...
$('.sous-menu_carnets').css("display", "block");
	...
	/*var hoverOpen = false;
            if (hoverOpen) {
                $('.nos_voyages').mouseover(function(){
                    hoverOpen = true;
                    $(this).stop(true, false).children('.nos_voyages_hover').animate({
                        top: "0"
                }, 500, function(){
                        $(this).stop(true, false).children('.nos_voyages_hover').animate({
                            top: "254"
        ...
        $(".nos_voyages").hover(function(){
            $(this).children('.nos_voyages_hover').stop(true, false).animate({  top: "0" },500);
        }, function() {
            $(this).children('.nos_voyages_hover').stop(true, false).animate({  top: "254" },500);
        });
    /* tab JS
